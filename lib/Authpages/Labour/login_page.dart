...
class LoginPageLabour extends StatefulWidget {
  const LoginPageLabour({Key? key}) : super(key: key);

  @override
  _LoginPageLabourState createState() => _LoginPageLabourState();
}

class _LoginPageLabourState extends State<LoginPageLabour> {
  ...
  userLogin() async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => MyHomePageLabours(),
        ),
      );
